...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2025 at 10:30 PM
...
(39, 74558, 7, 8, 12, 1, 20999, 'pending', '2025-04-18 15:18:04'),
(40, 76501, 7, 8, 12, 1, 20999, 'pending', '2025-04-18 15:18:04'),
(41, 76501, 7, 9, 11, 1, 30000, 'pending', '2025-04-18 15:18:04'),
(42, 71676, 7, 8, 12, 2, 20999, 'pending', '2025-04-18 15:18:04'),
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `user_type`, `create_on`, `profile_image`) VALUES
...
--
ALTER TABLE `addcarts`
  MODIFY `addcart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
